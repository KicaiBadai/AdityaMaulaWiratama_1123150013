...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _loginEmail() async {
    ...
    final auth = context.read<my.AuthProvider>(); // ← Pakai my.
  ...
  void _handleLoginResult(bool ok, my.AuthProvider auth) {
    // ← Pakai my.
    if (ok) {
      Navigator.pushReplacementNamed(context, AppRouter.dashboard);
    } else if (auth.status == my.AuthStatus.emailNotVerified) {
      // ← Pakai my.
  ...
  Widget build(BuildContext context) {
    final isLoading = context.watch<my.AuthProvider>().isLoading; // ← Pakai my.
